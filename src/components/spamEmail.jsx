...
class Spam extends Component{
    ...
    render () {
        return(
            <div>
                {this.props.spamMessages.map( messages => {
                    return(
                                ...
                                <div className='m-l-5 message-card-items h-60' onClick={() => this.updateOnClick(messages)}>
                                    ...
                                    <div className={`w-95 m-l-5 fs-12 ${messages.unread ? 'colorBlue' : ''}`}>
                                        <div className='row m-l-0'>
                                            ...
                                            <div className='row col-md-1 displayNone'><span onClick={()=>this.props.deleted(messages,'spam')}><i className="fa fa-trash trashIcon"></i></span></div>
                                        </div>
                                    </div>
